...
<section class="about">
    <div class="main">
        ...
        <div class="about-text">
            <h2>Serie <span>B</span></h2>
            <p>El Campeonato Ecuatoriano de Fútbol Serie B 2022, llamado oficialmente LigaPro Betcris Serie B 2022 es la cuadragésima quinta (45.ª) edición de la Serie B del fútbol profesional ecuatoriano y la cuarta (4.ª) bajo la denominación de LigaPro.
                El torneo es organizado por la Liga Profesional de Fútbol del Ecuador y entrega dos cupos a la Serie A de la siguiente temporada. Comenzó a disputarse el 15 de marzo y finalizará el 26 de octubre.</p>
        </div>
    </div>
</section>
