...
@section('content')
    @isset($equipo)
        <form action="{{route('serieBE1.update', $equipo)}}" method="post">
            @csrf
            @method('put')
            <h2>Serie B E1</h2>
            <div class="grid-2">
            ...
            <div class="grid-2">
                <h4>Equipo</h4>
                <input type="text" name="equipo" placeholder="Equipo" value="{{$equipo->equipob}}" maxlength="80" readonly="True" required>
            </div>
            <div class="grid-2">
            ...
            </div><input type="submit" value="Crear">
        </form>
    @endisset

    @if(!isset($equipo))
    <form action="{{route('serieBE1.new')}}" method="post">
        @csrf
        <h2>Serie B E1</h2>
        <div class="grid-2">
            <h4>Temporada</h4>
    ...
    @endif
    <a href="{{route('serieBE1')}}"><button class="button-31" role="button">Regresar</button></a>
