...
<section id="content">
    ...
    <main>
        <div class="head-title">
            <div class="left">
                <h1>SERIE B | PRIMERA ETAPA</h1>
            </div>
        </div>

        <div class="btn-crear">
            <a href="{{route('serieBE1.create')}}"><button type="button" class="button4 button3">+</button></a>
        </div>
                        ...
                        @isset($SerieB_E1)
                            @foreach($SerieB_E1 as $equipo)
                                <tr>
                                    ...
                                    <td>{{$equipo->dg}}</td>
                                    <td>{{$equipo->pts}}</td>
                                    <td><a href="{{route('serieBE1.edit', $equipo)}}"><button type="button" class="button button1">Actualizar</button></a></td>
                                    <td>
                                        <form action="{{route('serieBE1.destroy', $equipo)}}" method="POST">
                                            @csrf
                                            @method('delete')
