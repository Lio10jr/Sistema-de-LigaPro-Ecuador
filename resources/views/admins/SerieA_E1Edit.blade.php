...
@section('content')
    @isset($equipo)
        <form action="{{route('serieAE1.update', $equipo)}}" method="post">
            @csrf
            @method('put')
            <h2>Serie A E1</h2>
            <div class="grid-2">
            ...
            <div class="grid-2">
                <h4>Equipo</h4>
                <input type="text" name="equipo" placeholder="Equipo" value="{{$equipo->equipo}}" maxlength="80" readonly="True" required>
            </div>
            <div class="grid-2">
    ...
    @if(!isset($equipo))
    <form action="{{route('serieAE1.new')}}" method="post">
        @csrf
        <h2>Serie A E1</h2>
        <div class="grid-2">
            <h4>Temporada</h4>
    ...
    @endif
    <a href="{{route('serieAE1')}}"><button class="button-31" role="button">Regresar</button></a>
