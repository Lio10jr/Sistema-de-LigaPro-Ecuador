...
<section id="content">
    ...
    <main>
        <div class="head-title">
            <div class="left">
                <h1>SERIE A | PRIMERA ETAPA</h1>
            </div>
        </div>

        <div class="btn-crear">
            <a href="{{route('serieAE1.create')}}"><button type="button" class="button4 button3">+</button></a>
        </div>
                        ...
                        @isset($Ligapro_E1)
                            @foreach($Ligapro_E1 as $equipo)
                                <tr>
                                    ...
                                    <td>{{$equipo->dg}}</td>
                                    <td>{{$equipo->pts}}</td>
                                    <td><a href="{{route('serieAE1.edit', $equipo)}}"><button type="button" class="button button1">Actualizar</button></a></td>
                                    <td>
                                        <form action="{{route('serieAE1.destroy', $equipo)}}" method="POST">
                                            @csrf
                                            @method('delete')
